...
class AppStateNotifier extends ChangeNotifier {
  Ecom4LifersFirebaseUser? initialUser;
  Ecom4LifersFirebaseUser? user;
  ...
  void update(Ecom4LifersFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            FFRoute(
              ...
              builder: (context, params) => ProductListWidget(
                catRefId: params.getParam('catRefId',
                    ParamType.DocumentReference, false, 'Store-Categories'),
              ),
            ),
            FFRoute(
              name: 'CartView',
              path: 'cartView',
              builder: (context, params) => CartViewWidget(),
            ),
            FFRoute(
              name: 'CheckoutView',
              path: 'checkoutView',
            ...
            FFRoute(
              ...
              path: 'liveVideoPage',
              asyncParams: {
                'streamData': getDoc('streams', StreamsRecord.serializer),
              },
              builder: (context, params) => LiveVideoPageWidget(
                streamData: params.getParam('streamData', ParamType.Document),
              ),
            )
