  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VideosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VideosRecord> videoVideosRecordList = snapshot.data!;
        // Return an empty Container when the document does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final videoVideosRecord = videoVideosRecordList.isNotEmpty
            ? videoVideosRecordList.first
            : null;
                ...
                child: Column(
                  ...
                  children: [
                    FutureBuilder<ApiCallResponse>(
                      future: YouTubeGroup.youTubeVideoCall.call(
                        part: 'snippet',
                        id: FFAppState().videoID,
                        key: FFAppState().key,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
